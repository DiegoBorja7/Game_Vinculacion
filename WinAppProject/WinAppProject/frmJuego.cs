...
namespace WinAppProject
{
    public partial class frmJuego : Form
    {
        ...
        {
            Icon vista;
            vista = new Icon(Application.StartupPath + @"/Mouse/icons8_Paper_Plane_48px.ico");
            this.Cursor = new Cursor(vista.Handle);
        }
        ...
        public void translatePicBox(PictureBox origen, PictureBox destino, PictureBox destino2)
        {
            if (origen.Bounds.IntersectsWith(destino.Bounds))
            {
                if (destino.Enabled == false)
                {
                    //Point punto = new Point(origen.Location.X, origen.Location.Y);
        ...
        public void translatePicBox(PictureBox origen, PictureBox destino, PictureBox destino2, PictureBox destino3, PictureBox destino4)
        {
            if (origen.Bounds.IntersectsWith(destino.Bounds))
            {
                if (destino.Enabled == false)
